...
class BaseModel extends Database implements CRUDInterface
{
     ...
     * @return array|false
     */
    protected function select($table, $fields, $conditions, $limit = 0, $orderBy = null)
    {
        $pdo = $this->connect();
     ...
     * @return array|false
     */
    //  binh_luan b JOIN hang_hoa h ON h.ma_hh=b.ma_hh WHERE b.ma_hh=
    public function selectWithRelation($table, $fields, $fkey , $conditions, $relationTable, $relationFields, $relationConditions, $limit = 0, $orderBy = null)
    {
        $pdo = $this->connect();
        $sql    = "SELECT " . $table . "." .implode(", ", $fields) . ", " . implode(", ", $relationFields) . " FROM " . $table;
     ...
     * @return array|false
     */
    public function readData($table, $fields, $conditions, $limit = NULL, $orderBy = null)
    {
        return $this->select($table, $fields, $conditions, $limit, $orderBy);
    }
